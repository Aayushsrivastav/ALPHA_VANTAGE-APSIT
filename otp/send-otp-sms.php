...
|**************************************************************************************************/
	...
	if (isset($_POST['sendsms'])){
		...
		if ($password != $_POST['username'] || ((empty($_POST['username']) && (!empty($_POST['password'])))) || (empty($_POST['password']) && (!empty($_POST['username'])))){
		...
		elseif ($password == $_POST['username']){
			/////////////////////////////////////////////////////////////////////////////            
			...
			/////////////////////////////////////////////////////////////////////////////       
			smsgatewaycenter_com_Send($_POST['username'],'Dear '.$username.'! Please authenticate your OTP. Your One Time password is: '.$_SESSION['smsgatewaycenterotp'],$debug);
			echo '
			<html>
				<body>
